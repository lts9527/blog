...
// notifyWrap.style = "position: fixed; right: 0px; top: 9px; transition-duration: 1s;"
// notifyWrap.style = "position: fixed; right: 0px; top: 9px; "
...
//注册
function register() {
    vue.prototype.$myMsgTest = myMsgTest
}
